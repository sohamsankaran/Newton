...
/*
 * $Id: HTBM-driver.h 49 2011-04-27 13:00:05Z xander $
 */
 ...
 *
 * HTBM-driver.h provides an API for the HiTechnic Barometric Sensor.\n
...
int HTBMreadMInHg(tSensors link);
...
int HTBMreadMInHg(tSensors link) {
  ...
  if (!writeI2C(link, HTBM_I2CRequest, 2))
    return -255;

  if (!readI2C(link, HTBM_I2CReply, 2))
    return -255;
